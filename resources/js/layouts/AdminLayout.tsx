...
const navigation = [
    ...
    { name: 'Produk', href: route('admin.products.index'), icon: CubeIcon },
    { name: 'Kategori', href: route('admin.categories.index'), icon: TagIcon },
    { name: 'Kasir', href: route('admin.cashiers.index'), icon: UserGroupIcon },
    { name: 'Transaksi', href: route('admin.transactions.index'), icon: ShoppingCartIcon },
    { name: 'Laporan', href: route('admin.reports.sales'), icon: ChartBarIcon },
];
